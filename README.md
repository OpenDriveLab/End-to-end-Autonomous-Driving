...
- Multi-modal sensor fusionbased deep neural network for end-to-end autonomous driving with scene understanding(IEEESJ, 2020)
...
- Trajectoryguided control prediction for end-to-end autonomous driving: A simple yet strong baseline(NIPS, 2022)
- Learning from all vehicles(CVPR, 2022)[[Paper]](http://arxiv.org/pdf/1709.04622v4)[[Code]](https://github.com/dotchen/LAV.git)![](https://img.shields.io/github/stars/dotchen/LAV.svg?style=social&label=Star&maxAge=2592000)
...
- Multitask learning with attention for end-to-end autonomous driving(CVPR)
- Urban driving with conditional imitation learning(ICRA, 2020)[[Paper]](http://arxiv.org/pdf/1912.00177v2)
...
- Learning endto-end autonomous driving using guided auxiliary supervision(ICVGIP, 2018)
...
- Visualbased autonomous driving deployment from a stochastic and uncertainty-aware perspective(IROS, 2019)
...
- Policybased reinforcement learning for training autonomous driving agents in urban areas with affordance learning(T-ITS, 2021)
...
- End-to-end modelfree reinforcement learning for urban driving using implicit affordances(CVPR, 2020)
...
- Behavior transformers: Cloning k modes with one stone(NIPS, 2022)[[Paper]](https://arxiv.org/abs/2206.11251)[[Code]](https://github.com/notmahi/bet.git)![](https://img.shields.io/github/stars/notmahi/bet.svg?style=social&label=Star&maxAge=2592000)
...
- End-to-end multimodal sensors fusion system for urban automated driving(NIPSW, 2018)
